...
from parameters import access_token, version, database_address, community_id, members_to_proceed
from community_loader import DataBase, DataBaseOperator, get_community_sizes
